...
public class HW8 {
    ...
    public static int [] reverse(int [] aoi, int i, int j) {
        ...
        if (j < aoi.length)
            swap(aoi, i, j);
        return reverse(aoi, i+1, j-1); // shut up error message
    }
    /*
    ...
    public static void main(String [] args) {
        ...
        // I changed the 8th call to be equal to 2 because that is the correct number
        // 2 should appear twice after index 4, not three times.
